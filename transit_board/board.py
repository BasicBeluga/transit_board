...
class TransitRow():
    ...
    def gen_transit_row(self):
        ...
        columns = urwid.Columns([
            ...
            (8, urwid.Text((exp_text_color, f' {nice_datetime(self.expected)}  '), align='left')),
        ])
        return columns
...
class Board():
    ...
    def create_view(self):
        ...
        self.rows = [
            urwid.Columns([
                (46, urwid.Text(('normal' if not transit_row_refresh_required else 'good_green', self.stop['stop_name']), align='left')),
        ...
        help_widget = [
            urwid.Text(('normal', '')),
            urwid.Columns([
                urwid.Text(('bold', '[(q) Quit]')), 
            ])
        ]
        pile = urwid.Pile(self.rows + self.transit_rows + help_widget)
